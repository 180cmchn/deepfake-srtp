...
class Settings(BaseSettings):
    ...
    # Security Settings
    SECRET_KEY: str = (
        "your-secret-key-change-this-in-production-make-it-very-long-and-random"
    )
    ...
    # CORS Settings
    _BACKEND_CORS_ORIGINS: str = "http://localhost:3000,http://127.0.0.1:3000,http://localhost:5173,http://127.0.0.1:5173,http://localhost:8000,http://127.0.0.1:8000"
